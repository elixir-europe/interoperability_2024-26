---
title: ELIXIR's Portfolio of FAIR-enabling products
---
...
- [FAIR Principles in a nutshell](https://doi.org/10.5281/zenodo.12167786)
- [FAIRsharing content: standards overview](https://doi.org/10.5281/zenodo.8186982)
- [FAIRsharing content: databases overview](https://doi.org/10.5281/zenodo.8186961)
- [FAIRsharing for you: developers and curators](https://doi.org/10.5281/zenodo.8186594)
- [FAIRsharing for you: librarians, trainers, data stewards](https://doi.org/10.5281/zenodo.8186609)
- [FAIRsharing for you: researchers](https://doi.org/10.5281/zenodo.8186952)

## The ELIXIR Research Data Management guidelines and FAQs

In collaboration with the ELIXIR Research Data Management Community, the Interoperability Platform contributed to the creation of a set of [guidelines and frequently asked questions about common research data management challenges](https://elixir-europe.org/what-we-offer/guidelines/data-management) (citable version published on [Zenodo](https://doi.org/10.5281/zenodo.14710086)). The guidelines are illustrated through a set of user journeys that leverage resources from the FAIR-enabling portfolio, such as the RDMkit, the FAIR Cookbook, FAIRsharing and the Data Stewardship Wizard (DSW), and the connections between them.
